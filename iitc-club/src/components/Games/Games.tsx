...
export const GAMES_FALLBACK = [
  {
    ...
    emoji: '/images/games/cs2-logo.jpg', image: '/images/games/Counter-Strike 2.jpg',
  ...
  },
  {
    ...
    emoji: '/images/games/cs-source-logo.jpg', image: '/images/games/cs-source.jpg',
  ...
  },
  {
    ...
    emoji: '/images/games/ping-pong-logo2.jpg', image: '/images/games/ping-pong.jpg',
  ...
  },
  {
    ...
    emoji: '/images/games/chess-logo.jpg', image: '/images/games/chess.jpg',
  ...
  },
  {
    ...
    emoji: '/images/games/football-logo.jpg', image: '/images/games/football.jpg',
  ...
  },
  {
    ...
    emoji: '/images/games/marathon-logo.jpg', image: '/images/games/marathon.jpg',
        ...
        <div className={styles.showcase}>
          ...
          >
            ...
            <div className={styles.panelTop}>
              ...
              <span className={styles.panelPlayers}>
                <Users size={13} /> {game.players}
              </span>
            </div>

            <div className={styles.panelEmoji}>
              {typeof game.emoji === 'string' && game.emoji.includes('/images/') ? (
                <Image
                  src={game.emoji}
                  alt={game.name}
                  width={100}
              ...
              >
                <div className={styles.listLeft}>
                  <span className={styles.listEmoji}>
                    {typeof g.emoji === 'string' && g.emoji.includes('/images/') ? (
                      <Image
                        src={g.emoji}
                        alt={g.name}
                        width={30}
                ...
                <div className={styles.listRight}>
                  <span className={styles.listPlayers}>
                    <Gamepad2 size={12} /> {g.activePlayers}
                  </span>
